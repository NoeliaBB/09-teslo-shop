...
import { count, delay, empty, forkJoin, map, Observable, of, switchMap, tap } from 'rxjs';
  ...
  getProducts(options: Options): Observable<ProductsResponse> {
    ...
    return this.http.get<ProductsResponse>(`${baseUrl}/products`, {
      params: {
        limit,
        offset,
        gender } }).pipe(tap( resp => console.log(resp)), tap((resp) => this.productsCache.set(key, resp)));
  }
